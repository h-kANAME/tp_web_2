		...
		<div class="col-md-3">
			<div class="card mb-2">
				...
				<div class="card-body">
					...
					<p class="card-text">Audífonos con micrófono PRO X para juegos, incorporta la tecnologia Blue Voice</p>
		...
		<div class="col-md-3">
			<div class="card mb-2">
				...
				<div class="card-body">
					...
					<p class="card-text">Audifonos Cloud con sonido envolvente 7.1 y con microfono con cancelacion de ruido</p>
					<a class="btn btn-dark">Detalles</a>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3">
			<div class="card mb-2">
				...
				<div class="card-body">
					...
					<p class="card-text">Mouse óptico ideal para viedojuegos, cuenta con el sensor Pixart PMW 3360</p>
					<a class="btn btn-dark">Detalles</a>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3">
			<div class="card mb-2">
				...
				<div class="card-body">
					...
					<p class="card-text">Diseño Ergonómico exclusivamente para usuarios diestros</p>
					<a class="btn btn-dark">Detalles</a>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3">
			<div class="card mb-2">
				...
				<div class="card-body">
					...
					<p class="card-text">Alfombrilla de ratón Logitech G240 de tela para juegos para juegos de bajo DPI</p>
					<a class="btn btn-dark">Detalles</a>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3">
			<div class="card mb-2">
				...
				<div class="card-body">
					...
					<p class="card-text">FURY S cuenta con bordes con costura uniforme antidesgaste para una mayor resistencia</p>
					<a class="btn btn-dark">Detalles</a>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3">
			<div class="card mb-2">
				...
				<div class="card-body">
					...
					<p class="card-text">Interruptores rojos lineales: garantizados para 50 millones de pulsaciones de teclas</p>
					<a class="btn btn-dark">Detalles</a>
				</div>
			</div>
		</div>
